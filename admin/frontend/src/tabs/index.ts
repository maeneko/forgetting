...
//   metadata.json  — { id, label, icon, order? } (манифест: описание + порядок)
...
// Вкладок может не быть вовсе (чистый каркас) — тогда TABS пустой, и оболочка
// показывает заглушку вместо контента.
